...
public class TestNGCustomReportListener implements IReporter {
	...
	private String reportTitle = "Iportal Customized Report";
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("<head>");
		out.println("<title>Iportal AutomationTest Report</title>");
	...
	protected void endHtml(PrintWriter out) {
		out.println("<center>Iportal AutomationTest Report</center>");
